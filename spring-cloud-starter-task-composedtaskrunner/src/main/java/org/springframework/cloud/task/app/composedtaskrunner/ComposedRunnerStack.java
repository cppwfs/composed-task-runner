 ...
 * @author Glenn Renfro.
 */
public class ComposedRunnerStack extends ComposedTaskVisitor {
	...
	public boolean preVisit(Flow flow) {
		System.out.println("Pre Visit Flow:  " + flow);
		flowStack.push(new FlowMarker(FlowMarker.FlowMarkerType.FLOW, flow.toString()));
		return true;
	}

	public void visit(Flow flow) {
		System.out.println("Visit Flow:  " + flow);

	}

	public void postVisit(Flow flow) {
		System.out.println("Post Visit Flow:  " + flow);
	...
	public boolean preVisit(TaskApp taskApp) {
		System.out.println("Pre Visit taskApp:  " + taskApp);
		return true;
	}

	public void visit(TaskApp taskApp) {
		System.out.println("Visit taskApp:  " + taskApp);
	...
	public void postVisit(TaskApp taskApp) {
		System.out.println("Post Visit taskApp:  " + taskApp);
	}
	...
	public boolean preVisit(Transition transition) {
		System.out.println("Pre Visit transition:  " + transition);
		return true;
	}

	public void visit(Transition transition) {
		System.out.println("Visit transition:  " + transition);
	}

	public void postVisit(Transition transition) {
		System.out.println("Post Visit transition:  " + transition);
	}
